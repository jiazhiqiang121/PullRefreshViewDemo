...
import com.jia.pullrefresh.demo.util.DisplayHelper;
 ...
 * <li>可在 xml 中使用 {@link } 这些属性或在 Java 设置对应的属性决定子View的开始位置、触发刷新的位置等值</li>
 * </ul>
 *
 * @author cginechen
 * @date 2016-12-11
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTargetRefreshOffset = array.getDimensionPixelSize(
                    ...
                    DisplayHelper.dp2px(getContext(), 72));
...
//        return new CustomRefreshView(getContext());
    }
    ...
    private void addLoadMoreView() {
        if (mLoadMoreView == null) {
            mLoadMoreView = createRefreshView();
        }
        if (!(mLoadMoreView instanceof IRefreshView)) {
            throw new RuntimeException("refreshView must be a instance of IRefreshView");
        }
        mIRefreshView = (IRefreshView) mLoadMoreView;
    ...
    public static class RefreshView extends AppCompatImageView implements IRefreshView {
        ...
        private static final int[] mColors = {Color.RED, Color.BLUE, Color.GREEN};
